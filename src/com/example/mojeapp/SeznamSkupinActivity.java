...
public class SeznamSkupinActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seznamskupin);
        updateList();
        }
    ...
    public void updateList() {
        ...
        ListAdapter adapter = new SimpleCursorAdapter(ctx,
                android.R.layout.simple_list_item_1, notes.getSkupiny(),
                from, to, 0);
	...
	public void onClickNovaSkupina(View btnAdd) {
